    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Admin'), ('CUSTOMER', 'Customer'), ('WORKER', 'Worker')], default='CUSTOMER', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('base_rate_per_hour', models.DecimalField(decimal_places=2, default=0.0, max_digits=10)),
                ...
                ('identity_proof', models.FileField(blank=True, null=True, upload_to='verification/')),
